...
@section('title', 'Tambah User Absen')
    ...
    <div class="container mx-auto px-6 py-8">
        <div class="max-w-2xl mx-auto bg-white rounded-lg shadow-md">
            ...
            <div class="p-6 border-b border-gray-200">
                <h4 class="text-xl font-semibold text-gray-800">Tambah User Absen Baru</h4>
                <p class="mt-1 text-sm text-gray-600">Isi detail di bawah ini untuk menambahkan user ke sistem absensi.</p>
            </div>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama" id="nama"
                            ...
                            value="{{ old('nama') }}" required placeholder="Contoh: Budi Santoso">
                        @error('nama')
                    ...
                    <div>
                        ...
                        <input type="text" name="uuid" id="uuid"
                            class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm
                                  placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                            value="{{ old('uuid') }}" required placeholder="Masukkan UUID unik secara manual">
                        @error('uuid')
                            <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <select name="kategori_id" id="kategori_id"
                            class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm
                   placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" required>
