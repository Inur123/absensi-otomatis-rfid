...
<div class="container mx-auto px-6 py-8">
    <div class="max-w-3xl mx-auto bg-white rounded-lg shadow-md">
        ...
        <div class="p-6 border-b border-gray-200">
            <h4 class="text-xl font-semibold text-gray-800">Tambah Jadwal Absensi Baru</h4>
            <p class="mt-1 text-sm text-gray-600">Isi detail di bawah untuk membuat jadwal baru.</p>
        </div>
            ...
            <div class="p-6">
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_jadwal" id="nama_jadwal" class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('nama_jadwal') }}" required placeholder="Contoh: Jam Kerja Kantor">
                        @error('nama_jadwal')
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                             ...
                             <input type="time" name="jam_mulai" id="jam_mulai" class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('jam_mulai') }}" required>
                             @error('jam_mulai')
                                <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                             @enderror
                        </div>
                        <div>
                             ...
                             <input type="time" name="jam_selesai" id="jam_selesai" class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('jam_selesai') }}" required>
                              @error('jam_selesai')
                                <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                             @enderror
                        </div>
